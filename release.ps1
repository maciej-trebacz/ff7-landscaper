...
$signatureFile = "src-tauri/target/release/bundle/nsis/FF7 Landscaper_${Version}_x64-setup.exe.sig"
...
try {
    ...
    $updaterJson.platforms.'windows-x86_64'.url = "https://github.com/maciej-trebacz/ff7-landscaper/releases/download/$Version/FF7.Landscaper_${Version}_x64-setup.exe"
...
Write-Host "Installer location: src-tauri/target/release/bundle/nsis/FF7 Landscaper_${Version}_x64-setup.exe" -ForegroundColor Cyan

$releaseUrl = "https://github.com/maciej-trebacz/ff7-landscaper/releases/new?tag=$Version"
