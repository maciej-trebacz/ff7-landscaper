...
export enum Mnemonic {
  ...
  FADE_OUT = "FADE_OUT",
  EXIT_UNDERWATER = "EXIT_UNDERWATER",
...
export const Opcodes: Record<number, OpcodeDefinition> = {
  ...
  0x30a: {
    ...
    stackParamsDef: [{ name: "Speed", description: "Vertical speed" }],
    notes: "Negative values will make the entity rise, positive values will make it fall.",
  },
  0x30b: {
    name: "set_y_offset",
    stackParams: 1,
  ...
  0x314: {
    ...
    stackParams: 2,
    codeParams: 0,
    mnemonic: Mnemonic.SET_RADIUS,
    namespace: Namespace.Point,
    description: "Configure radius for a point light.",
    stackParamsDef: [
      { name: "Outer Radius", description: "Light outside this radius fades out to 0" },
      { name: "Inner Radius", description: "Light inside this radius is uniform" },
    ],
  ...
  0x33a: {
    name: "set_vertical_speed_with_follow",
    stackParams: 1,
    codeParams: 0,
    mnemonic: Mnemonic.SET_VERT_SPEED2,
    namespace: Namespace.Entity,
    description: "Set active entity's vertical speed with camera following.",
    stackParamsDef: [{ name: "Speed", description: "Vertical speed" }],
    notes: "Negative values will make the entity fall, positive values will make it rise.",
  },
  0x33b: {
    name: "fade_out",
    stackParams: 2,
    ...
    notes: "The engine does not wait for this opcode to finish, so you need to insert a wait opcode after it for the complete effect. The speed has to be greater than 1 for the fade to be visible. \n\nNOTE: This opcode normally fades the screen to black, but if a specific sound effect is played just before it (sound ID 11 or 433) it will actually fade out to white, but only for high speed values like 250. Don't worry about this too much, it's just FF7 things.",
  },
  0x33c: {
    name: "exit_underwater",
    stackParams: 0,
    codeParams: 0,
    mnemonic: Mnemonic.EXIT_UNDERWATER,
    namespace: Namespace.System,
    description: "Surfaces the submarine and changes the map to overworld.",
  },
  0x33d: {
  ...
  0x348: {
    ...
    notes: "Fades the screen to black. The speed has to be greater than 1 for the fade to be visible.",
  },
  0x349: {
  ...
  0x34c: {
    ...
    notes: "Changes submarine color only; no gameplay effect. Because of how this opcode is implemented some negative values are treated as valid colors.",
  },
  0x34d: {
    name: "show_layer",
    stackParams: 3,
